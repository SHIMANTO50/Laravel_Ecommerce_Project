        ...
        {{-- form start --}}
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" placeholder="Enter Your Email" class="form-control  fc-outline-dark" type="email" name="email" :value="old('email')" required autofocus />
                    </div>
        
                    <!-- Password -->
                    <div class="form-group mt-4">
        
                        <input id="password" placeholder="Enter Your Password" class="form-control fc-outline-dark "
                                        type="password"
                                        name="password"
                   ...
                   <button type="submit" class="btn btn-info btn-block">Sign In</button>
                    ...
                    <a class="btn btn-success btn-sm" href="{{ Route('googlegoto')}}"><i class="fab fa-google"></i>Login with Google</a>
